#ifndef _ROS_dlonurdf_Jamming_pressure_controler_h
#define _ROS_dlonurdf_Jamming_pressure_controler_h
...
namespace dlonurdf
{
  ...
  class Jamming_pressure_controler : public ros::Msg
  {
    public:
      uint8_t motorPWM;
      uint8_t airPWM;
    ...
    const char * getType(){ return "dlonurdf/Jamming_pressure_controler"; };
